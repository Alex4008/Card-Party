...
public class LocalUno {
	...
	public LocalUno(Main m, int numPlayers, int difficulty, int startingPlayer, boolean allowDrawFourAnyTime, boolean allowStackingDrawTwos, boolean drawUntilPlay, Client c) {
		this.m = m;
		this.theClient = c;
	...
	public LocalUno(Main m, int numPlayers, Client c) {
		this(m, numPlayers, 0, -1, true, false, true, c);
	}
	...
	public void tick(Main m) {
		...
		if(drawDeck.getSize() == 0 && theClient == null) {
			resetDiscard();
